  ...
  return (
    <div className={styles.container}>
      ...
      <form className={styles.form} onSubmit={handleSubmit(onSubmit, onError)}>
        <label htmlFor="name">Enter the name of your product</label>
        <input
          id="name"
          type="text"
          placeholder="Fitness gripper with rep count..."
          {...register("productName", {
            required: true,
          })}
        />
        <label htmlFor="price">Enter the price of your product</label>
        <input
          id="price"
          type="text"
          placeholder="13.22..."
        ...
        />
        <label htmlFor="category">Enter the categories of your product</label>
        <Select
          isMulti={true}
